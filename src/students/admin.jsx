...
// import HomeWorkLoad from './page/Homeworkload.jsx';
import StudentMoudel from '../components/modelout'
...
// 菜单栏
  const items = [
    getItem('老师列表', '1', <ControlFilled />),
    getItem('模型展示', '3', <GoldenFilled />),
    getItem('模型列表', 'sub', <CodeSandboxSquareFilled />, [
      getItem('模型1', '10'),
      getItem('模型2', '11'),
      getItem('模型3', '12'),
      getItem('模型4', '13'),
    ...
    getItem('图形计算器','4',<EditFilled />),
    getItem('用户设置', '5', <SettingFilled />),
  ...
  return (
    <Layout className='Layout' hasSider>
      <Sider trigger={null} collapsible collapsed={collapsed} className='SideM'
        style={{ backgroundColor: 'white', overflowY: 'scroll', overflowX: 'hidden' }}>
        {/* 侧边栏的logo */}
        <div className="logo" >
          {/* logo切换三目判断 */}
          {
            collapsed ? (
              ...
              <img src="https://ts1.cn.mm.bing.net/th/id/R-C.aa2bbc66524533543876eac397de0215?rik=5z8FO41CXqqVuQ&riu=http%3a%2f%2fzgh.com%2fwp-content%2fuploads%2f2019%2f12%2fGEOMETRY_Logo_EN2.png&ehk=mKd7eKaHfJ8%2foX1VCvJ7t0aGqkAtAyQmUQiis59cCjM%3d&risl=&pid=ImgRaw&r=0"
                width="200"
                alt="logo"
                height='60'
              />
        ...
        <Menu
          ...
          onClick={(item) => {
            ...
            setKey(item.key);  //一点要获取到单独的key值才有用
          }}
